...
| `oidc.issuer`                           | OpenID Connect issuer as returned in the "iss" field of the JWT payload                                                                                                                               | `https://aai.egi.eu/oidc/`         |
...
| `image.tag`                             | Release tag to install                                                                                                                                                                                | `2.4.2`                            |
...
| `volume.supervisorVersion`              | [FaaS Supervisor](https://github.com/grycap/faas-supervisor) version to use if ServerlessBackend is enabled                                                                                           | `1.5.0`                            |
| `volume.watchdogVersion`                | [OpenFaaS Watchdog](https://github.com/openfaas/classic-watchdog) version to use in the OSCAR's services                                                                                              | `0.2.0`                            |
